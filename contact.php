...
<html lang="fr">
   ...
   <body id="page-top">
      ...
      <div class="row">
          ...
          <div class="col-sm-2">
            <p><a href="mailto:bureau@emdiables.fr">bureau@emdiables.fr</a></p>
          </div>
      </div>
      <hr>
      <div class="row">
          ...
          <div class="col-sm-2">
            <p><a href="mailto:polesponsors@emdiables.fr">polesponsors@emdiables.fr</a></p>
          </div>
      </div>
      <hr>
      <div class="row">
          <div class="col-sm-2">
            <h5>Pôle Logistique </h5>
          </div>
          <div class="col-sm-2">
            <p><a href="mailto:polelogistique@emdiables.fr">polelogistique@emdiables.fr</a></p>
          </div>
      </div>
  </div>
